...
transform panicfast(x=640, z=0.80):
    xcenter x yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True
    parallel:
        ease 0.6 yoffset 25
        ease 0.6 yoffset 0
...
#This makes the charater shakes like when natsuki grabs her manga from the closet
...
#loops above
transform wiggle_loop(x=640, z=0.80):
    xcenter x yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True
    easein 0.15 xoffset 20
    easeout 0.15 xoffset 0
    easein 0.15 xoffset -15
...
transform slide_from_top(x=640, z=0.80):
    on show:
        xcenter x yanchor 1.0 ypos -20 zoom z*1.00 alpha 1.00 subpixel True
        easein 1.0 ypos 1.03  # Adjust this value to match tcommon

transform slide_from_top_to_bottom(x=640, z=0.80):
    on show:
        xcenter x yanchor 0.0 ypos -1000 zoom z*1.00 alpha 1.00 subpixel True
        easein 0.5 ypos 1000  # Adjust the duration as needed
...
#Same positioning, but with unused panic animation
transform p41:
    panic(200)
transform p42:
    panic(493)
...
#Same positioning, but with faster panic animation
transform pf41:
    panicfast(200) 
transform pf42:
    panicfast(493)
...
#Same positioning, but with wiggle animation
transform w41:
    wiggle(200) 
transform w42:
    wiggle(493)
...
#Same positioning, but with looped wiggle animation
transform wl41:
    wiggle_loop(200) 
transform wl42:
    wiggle_loop(493)
...
#Same positioning, but with slide from top to center animation
transform st41:
    slide_from_top(200) 
transform st42:
    slide_from_top(493)
...
transform st11:
    slide_from_top(640)
#Same positioning, but with slide from top to bottom animation

transform tb41:
    slide_from_top_to_bottom(200) 
transform tb42:
    slide_from_top_to_bottom(493)
transform tb43:
    slide_from_top_to_bottom(786)
transform tb44:
    slide_from_top_to_bottom(1080)
transform tb31:
    slide_from_top_to_bottom(240)
transform tb32:
    slide_from_top_to_bottom(640)
transform tb33:
    slide_from_top_to_bottom(1040)
transform tb21:
    slide_from_top_to_bottom(400)
transform tb22:
    slide_from_top_to_bottom(800)
transform tb11:
    slide_from_top_to_bottom(640)
