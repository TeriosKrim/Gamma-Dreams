...
define config.name = "DDLC AND HER"
...
#   Linux: $HOME/.renpy/
define config.save_directory = "DDLCANDHER"
...
init python:
    ...
    build.classify("game/**.ttf", "mod_assets all")
    build.classify("game/**.otf", "mod_assets all")
